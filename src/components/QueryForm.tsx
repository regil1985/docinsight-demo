    ...
    return (
        <div className="min-h-screen w-screen bg-gray-50 text-gray-800">
            <div className="w-full p-4 sm:p-8">
                ...
                {/* Summary */}
                {summary && (
                    <div className="bg-yellow-100 border-l-4 border-yellow-400 p-6 w-full mb-6 rounded-lg shadow">
                ...
                {/* Results */}
                {responses.length > 0 && (
                    <div className="bg-white border border-gray-200 rounded-md p-6 w-full space-y-6 shadow">
                        ...
                        {responses.map((res, i) => {
                            ...
                            return (
                                <div
                                    key={i}
                                    className="p-4 bg-white border border-gray-300 rounded-lg shadow-sm space-y-2">
                                    ...
                                    <div className="text-sm text-gray-500 pt-2 border-t border-gray-200">
                                        ...
                                        <p><span className="font-semibold text-gray-600">Confidence Score:</span> 
                                            <span className="text-blue-600 font-bold">{scorePart}</span></p>
                                    </div>
                                </div>
                            );
                        })}
